...
def query_platformdata_general_randomcount_activerecords(platform_vars, platform_settings, sql_connection,
...
if __name__ == "__main__":
    ...
    if (platform_settings.datatier_technologies == "postgresql"):
        ...
        query_platformdata_general_randomcount_activerecords(platform_vars=platform_vars, platform_settings=platform_settings,
        sql_connection=postgres_sql_connection, table_name=tbl_name, record_count=random_record_count)
    if (platform_settings.datatier_technologies == "sqlite"):
        sql_connection = connectors.postgresql.create_connection(platform_settings.platform_datatier)
        query_platformdata_general_randomcount_activerecords(platform_vars=platform_vars, platform_settings=platform_settings, sql_connection=sql_connection,
        table_name=tbl_name, record_count=random_record_count)
